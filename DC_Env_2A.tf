module "DC_Enviroment_2A" {

  #source  = "WEEMR/DataCenter_Enviroment_2A/aws"
  #version = "0.1.0"
  ...
  #            Terraform Registery Module = https://registry.terraform.io/modules/WEEMR/DataCenter_Enviroment_2A/aws/latest

  #                             Source Code = https://github.com/WEEMR/terraform-aws-DataCenter_Enviroment_2A
...
output "AWS_US_East_Hub_1_VPC_ID" {
  value = module.DC_Enviroment_2A.AWS_US_East_Hub_1_VPC_ID
}

output "AWS_US_East_Spoke_1_VPC_ID" {
  value = module.DC_Enviroment_2A.AWS_US_East_Spoke_1_VPC_ID
}
...
output "hub_1_WAN_1_IP" {
  value = module.DC_Enviroment_2A.hub_1_WAN_1_EIP
}

output "hub_1_WAN_2_IP" {
  value = module.DC_Enviroment_2A.hub_1_WAN_2_EIP
}

output "hub1_FGT_DNS_Name" {
  value = module.DC_Enviroment_2A.hub1_FGT_DNS_Name
}

output "hub1_Linux_DNS_Name" {
  value = module.DC_Enviroment_2A.hub1_Linux_DNS_Name
}

output "hub1_Windows_DNS_Name" {
  value = module.DC_Enviroment_2A.hub1_Windows_DNS_Name
}
...
output "spoke_1_WAN_1_IP" {
  value = module.DC_Enviroment_2A.spoke_1_WAN_1_EIP
}

output "spoke_1_WAN_2_IP" {
  value = module.DC_Enviroment_2A.spoke_1_WAN_2_EIP
}

output "spoke1_FGT_DNS_Name" {
  value = module.DC_Enviroment_2A.spoke1_FGT_DNS_Name
}

output "spoke1_Linux_DNS_Name" {
  value = module.DC_Enviroment_2A.spoke1_Linux_DNS_Name
}
